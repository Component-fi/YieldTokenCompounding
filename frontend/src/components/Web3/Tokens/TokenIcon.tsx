...
export const TokenIcon: React.FC<TokenIconInterface> = (props) => {
  const elementAddresses: ElementAddresses =
    useRecoilValue(elementAddressesAtom);
  ...
  if (tokenUrl) {
    return (
      <Flex h={10} w={10}>
        <img src={tokenUrl} alt={`${tokenName} Logo`} />
      </Flex>
    );
  }
...
const BackupImage: React.FC<{}> = () => {
  return (
    ...
    >
      <g>
        <path
          d="M14.125,0C6.337,0,0,6.337,0,14.125S6.337,28.25,14.125,28.25S28.25,21.913,28.25,14.125S21.913,0,14.125,0z M4,14.125
