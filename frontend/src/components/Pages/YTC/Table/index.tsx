...
const ResultsTable: React.FC<TableProps> = () => {
  ...
  const handlePredictedRateChange: React.ChangeEventHandler<
    HTMLInputElement
  > = (e) => {
  ...
  return (
    <Flex id="results-table" py={5} flexDir="column" gridGap={5}>
      <Card>
        <FormLabel
          flexDir="row"
          justify="center"
        ...
        >
          <Flex flexDir="row" alignItems="center" gridGap={2}>
            ...
            <InfoTooltip
              label={copy.tooltips.estimated_variable_rate}
              h={3}
              w={3}
            />
          </Flex>
        ...
        <InputGroup bgColor="input_bg" rounded="2xl">
          ...
          />
          <InputRightAddon bgColor="input_bg">
            <Text
      ...
      <Card>
        ...
        >
          <Flex flexDir="row" alignItems="center" gridGap={2}>
            Number of Compounds
            <InfoTooltip
              label={copy.tooltips.number_of_compounds}
              w={3}
              h={3}
            />
          </Flex>
            ...
            <Tr>
              ...
              <Th isNumeric>
                <Flex alignItems="center" gridGap={1}>
                  <Text>Yield Tokens</Text>
                  <InfoTooltip label={copy.tooltips.yield_tokens} />
                </Flex>
              </Th>
              <Th isNumeric>
                <Flex alignItems="center" gridGap={1}>
                  <Text>Tokens Spent</Text>
            ...
            {simulationResults.map((result: YTCOutput, index) => {
              return (
                <ResultsTableRow
                  ...
                  baseTokenName={
                    simulationResults[0].receivedTokens.baseTokens.name
                  }
                />
              );
            })}
