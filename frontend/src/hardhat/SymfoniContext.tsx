...
import { YTCEth } from "./typechain/YTCEth";
import { YTCEth__factory } from "./typechain/factories/YTCEth__factory";
...
import { YTCEthCurve } from "./typechain/YTCEthCurve";
import { YTCEthCurve__factory } from "./typechain/factories/YTCEthCurve__factory";
...
export const YTCEthContext = React.createContext<SymfoniYTCEth>(emptyContract);
export const YieldTokenCompoundingContext = React.createContext<SymfoniYieldTokenCompounding>(emptyContract);
export const YTCEthCurveContext = React.createContext<SymfoniYTCEthCurve>(emptyContract);
...
export interface SymfoniYTCEth {
    instance?: YTCEth;
    factory?: YTCEth__factory;
}
...
export interface SymfoniYTCEthCurve {
    instance?: YTCEthCurve;
    factory?: YTCEthCurve__factory;
}
...
export const Symfoni: React.FC<SymfoniProps> = ({
    ...
    const [YTCEth, setYTCEth] = useState<SymfoniYTCEth>(emptyContract);
    const [YieldTokenCompounding, setYieldTokenCompounding] = useState<SymfoniYieldTokenCompounding>(emptyContract);
    const [YTCEthCurve, setYTCEthCurve] = useState<SymfoniYTCEthCurve>(emptyContract);
    ...
    useEffect(() => {
        ...
        const doAsync = async () => {
            ...
            const finishWithContracts = (text: string) => {
                setYTCEth(getYTCEth(_provider, _signer))
                setYieldTokenCompounding(getYieldTokenCompounding(_provider, _signer))
                setYTCEthCurve(getYTCEthCurve(_provider, _signer))
    ...
    const getYTCEth = (_provider: providers.Provider, _signer?: Signer) => {

        const contractAddress = "0xC5C14557eDF336731a44E35aCF4b9A3e2eAC3E72"
        const instance = _signer ? YTCEth__factory.connect(contractAddress, _signer) : YTCEth__factory.connect(contractAddress, _provider)
        const contract: SymfoniYTCEth = {
            instance: instance,
            factory: _signer ? new YTCEth__factory(_signer) : undefined,
        }
        return contract
    }
        ;
    const getYieldTokenCompounding = (_provider: providers.Provider, _signer?: Signer) => {
        ...
        const contractAddress = "0xe4ecfc8aff5bea1e06618e862491e190239f4d1e"
        ...
        ;
    const getYTCEthCurve = (_provider: providers.Provider, _signer?: Signer) => {
        let instance = _signer ? YTCEthCurve__factory.connect(ethers.constants.AddressZero, _signer) : YTCEthCurve__factory.connect(ethers.constants.AddressZero, _provider)
        const contract: SymfoniYTCEthCurve = {
            instance: instance,
            factory: _signer ? new YTCEthCurve__factory(_signer) : undefined,
        }
        return contract
    }
        ;
            ...
            <ProviderContext.Provider value={[provider, setProvider]}>
                <SignerContext.Provider value={[signer, setSigner]}>
                    <CurrentAddressContext.Provider value={[currentAddress, setCurrentAddress]}>
                        <YTCEthContext.Provider value={YTCEth}>
                            <YieldTokenCompoundingContext.Provider value={YieldTokenCompounding}>
                                <YTCEthCurveContext.Provider value={YTCEthCurve}>
                                ...
                                </YTCEthCurveContext.Provider >
                            </YieldTokenCompoundingContext.Provider >
                        </YTCEthContext.Provider >
