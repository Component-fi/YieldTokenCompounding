...
export const getUnderlyingTotal = async (elementAddresses: ElementAddresses, trancheAddress: string, signerOrProvider: Signer | ethers.providers.Provider): Promise<number> => {
    // get the tranche
    ...
    const wrappedPosition = new Contract(wrappedPositionAddress, IWrappedPosition.abi, signerOrProvider) as IWrappedPositionType;
    const wrappedPositionERC20 = new Contract(wrappedPositionAddress, ERC20.abi, signerOrProvider) as ERC20Type;
